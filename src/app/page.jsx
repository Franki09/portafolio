...
export default function Home() {
  return (
    <div className="bg-primary-light h-full pt-20">
      <div className="h-screen p-5 flex flex-col justify-center items-center text-center gap-8 relative z-10">
        ...
        <Link
          ...
          className="inline-flex items-center gap-3 bg-primary-base text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-dark hover:scale-105 transition-all shadow-xl"
        >
          <FaDownload size={20} />
          Descargar CV
        </Link>
