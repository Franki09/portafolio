          ...
          <div className="scroll-container flex gap-5">
            {projects.map((proyecto, index) => (
              <div
                ...
                className="w-[350px] h-[400px] flex flex-col flex-shrink-0 bg-secondary-light rounded-md border-2 border-secondary-dark"
              >
                ...
                <div className="flex-1 flex flex-col p-3">
                  <h3 className="mb-2">{proyecto.name}</h3>
                  <p className="flex-1 mb-2">{proyecto.desc}</p>
                  ...
                  <div className="flex justify-around items-center m-2 gap-3">
                    <Link
                      ...
                      className="inline-block text-center p-2 w-full bg-primary-base text-white rounded-full hover:bg-primary-dark transition-colors"
                    >
                      Repositorio
                    </Link>
                    <Link
