...
function Proyects() {
  ...
  return (
    <div id="proyects" className="flex flex-col justify-center items-center p-10">
      <div className="mb-8">
        <h1 className="text-center text-primary-dark text-5xl font-semibold pb-2">Mis proyectos principales</h1>
        <p className="mb-5 text-center text-gray-600 text-2xl ">
      ...
      <h2 className="text-center text-primary-dark text-3xl font-semibold pb-2">Mis proyectos secundarios</h2>
