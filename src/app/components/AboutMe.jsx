      ...
      <div id="about" className="bg-primary-base flex justify-center items-center gap-20 p-10">
        ...
        <div className="bg-secondary-light rounded-md p-8 flex-col">
          ...
          <p className="max-w-2xl pb-3">
            ...
            en dar vida a interfaces modernas, funcionales y bien estructuradas. Más allá del código, lo que más me motiva es
            pensar en cómo cada detalle puede mejorar la experiencia de usuario y hacer que una web sea intuitiva y agradable de
            usar.
            <br /> Me considero una persona creativa, responsable y colaboradora, siempre abierta a aprender algo nuevo y a
            compartir lo que sé. Valoro mucho el trabajo en equipo, porque creo que los mejores proyectos surgen cuando las ideas
            y perspectivas se combinan. Me gusta trabajar en entornos ágiles y dinámicos, donde puedo crecer profesionalmente y
            aportar no solo en lo técnico, sino también en lo humano. <br /> Actualmente busco seguir evolucionando como
            profesional, enfrentar nuevos desafíos y, sobre todo, aportar valor en cada proyecto en el que participe. Para mí,
            cada línea de código es una oportunidad de aprender, mejorar y crear algo que realmente marque la diferencia.
          </p>
